...
abstract class NodeAbstract implements NodeInterface, \IteratorAggregate
{
    protected $subNodes;
     ...
     *
     * @return \PHPParser\Comment\DocComment Doc comment object or null
     */
    public function getDocComment() {
        ...
        if (!$lastComment instanceof DocComment) {
            return null;
        }
