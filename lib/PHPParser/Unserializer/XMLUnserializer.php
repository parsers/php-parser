...
class XMLUnserializer implements Unserializer
{
    protected $reader;
    ...
    {
        //$className = '\PHPParser\\Node\\' . str_replace('_', '\\', $this->reader->localName);
        $className = str_replace('_', '\\', $this->reader->localName);
